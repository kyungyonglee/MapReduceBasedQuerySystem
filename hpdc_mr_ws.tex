...
\maketitle
\begin{abstract}
Resouce monitoring and discovery are important processes for building a large computing cluster.
...
Analysis and simulation result prove that our system is scalable with respect to the increased number of nodes, and the performance comparison with Sword, a DHT based resouce query algorithm,
